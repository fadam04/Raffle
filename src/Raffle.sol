...
contract Raffle is VRFConsumerBaseV2Plus, AutomationCompatibleInterface {
    ...
    IVRFCoordinatorV2Plus private immutable I_VRF_COORDINATOR_CONTRACT;
    ...
    constructor(
        ...
        I_VRF_COORDINATOR_CONTRACT = IVRFCoordinatorV2Plus(_vrfCoordinator);
        i_gasLane = _gasLane;
    ...
    function performUpkeep(bytes calldata /* performData */ ) public {
        ...
        uint256 requestId = I_VRF_COORDINATOR_CONTRACT.requestRandomWords(
